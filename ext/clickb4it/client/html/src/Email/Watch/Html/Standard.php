	...
	implements \Aimeos\Client\Html\Common\Client\Factory\Iface
{
	...
	public function addData( \Aimeos\MW\View\Iface $view, array &$tags = [], &$expire = null )
	{
		 ...
		 */
		$file = $view->config( 'client/html/email/logo', 'client/html/themes/forhumans/media/aimeos.png' );
		...
		$path = $view->config( 'client/html/common/template/baseurl', 'client/html/themes/forhumans' );
